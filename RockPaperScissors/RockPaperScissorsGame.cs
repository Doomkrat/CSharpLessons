...
namespace RockPaperScissors
{
    class RockPaperScissorsGame
    {
        ...
        private void PrintScore()
        {
            ...
            Console.WriteLine("Looses: {0}", losses);
        ...
        private void DetermineWinner(string userChoice, string computerChoice)
        {
            ...
            else if ((userChoice == "R" && computerChoice == "S")|| (userChoice == "S" && computerChoice == "P")||
                (userChoice == "P" && computerChoice == "R"))
            {
                wins++;
                Console.WriteLine("You picked {0}, and computer picked {1}, you win!", ConvertChoiceToWord(userChoice),
                    ConvertChoiceToWord(computerChoice));
            }
            else
            {
                losses++;
                Console.WriteLine("You picked {0}, and computer picked {1}, you loose!", ConvertChoiceToWord(userChoice),
                    ConvertChoiceToWord(computerChoice));
            }
        }
